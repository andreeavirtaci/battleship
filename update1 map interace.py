...
class JocBattleship:
    def __init__(self):
        ...
        self.label_orientare = tk.Label(self.placare_frame, text="Introduceți orientarea (Above(A)/Below(B)/Right(R)/Left(L):")
    ...
    def plaseaza_nava(self):
        ...
        if self.nave_de_plasat:
            ...
            if self.jucator_activ.plaseaza_nava(start_x, start_y, dimensiune, directie):
