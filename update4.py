...
class Jucator:
    ...
    #functia pt atac pt fereastra noua
...
class JocBattleship:
    ...
    def start_1vs_computer(self):
        self.select_frame.destroy()
        self.root.destroy()
        self.start_empty_window()

    def start_empty_window(self):
        new_root = tk.Tk()
        new_root.title("1 vs Computer - Empty Window")
        new_root.mainloop()
    ...
    def setup_game(self):
        ...
        #buton in caz ca un jucator vrea sa renunte
        self.button_renunta = tk.Button(self.placare_frame, text="Renunțare", command=self.renunta)
        ...
        #butonul de ajutor cu instructiuni
    ...
    #in caz ca vrea sa abandoneze jocul
    def renunta(self):
        self.root.destroy()
    ...
    #pt functia de atac a persoanelor
    def ataca(self):
    ...
    #fereastra de atac unde o sa apara x-urile si 0-urile
    ...
    #sa se schimbe jucatorul la fiecare atac
    ...
    #verificarea jucatorului dupa doborarea navelor
    ...
    #mesajul care apare cand castiga cineva
